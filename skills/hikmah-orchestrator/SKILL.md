...
description: >
  Use for complex, multi-layered situations that span judgment, AI failure analysis,
...
Use this skill when one lens is not enough. Do not stack frameworks for decoration. Load only the capabilities that change the answer.
...
- Never label a claim verified unless it was actually checked against available evidence.
- Do not manufacture certainty when evidence is incomplete.
- Do not treat this framework as medical, legal, financial, security, religious, or other professional authority.
- When a domain claim matters, route to current primary sources or qualified specialists.
...
3. Two to four relevant principles or controls.
4. Decision or recommendation with tradeoffs.
5. Three to five immediate actions.
